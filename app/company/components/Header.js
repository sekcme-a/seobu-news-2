    ...
    <header className="fixed w-full bg-white shadow-sm z-50 border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <Link
            href="/"
            className=" relative text-3xl w-[120px] h-[40px] md:w-[160px] md:h-[45px] font-extrabold text-blue-900 tracking-tighter"
          >
            <span className="sr-only">서부뉴스 - 내일의 중심이 되는 뉴스</span>
            <Image
